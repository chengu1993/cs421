...
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;
      (err yypos ("unescaped line break in string");
                        newline yypos; continue ()))
...
fun yyAction8 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (append (fmtAsc (substring (yytext, 1, 3))); continue ())
      end
...
fun yyAction12 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (append (fmtCtrl (String.sub (yytext, 2))); continue ())
      end
fun yyAction13 (strm, lastMatch : yymatch) = (yystrm := strm;
      (cmts := yypos :: !cmts; YYBEGIN COMMENT; continue ()))
...
fun yyAction56 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.INT (toInt yytext, yypos, yypos + size yytext))
      end
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ110(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction54(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ112(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
...
fun yyQ113 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ113(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ28 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ29(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
...
fun yyQ27 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ30(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
              else yyAction15(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"2"
              ...
              then if inp = #" "
                  ...
                  then yyAction5(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"_"
              then yyAction5(strm, yyNO_MATCH)
            else if inp < #"_"
              then if inp = #"]"
                  ...
                  then if inp = #"\\"
                      then yyQ14(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
                      else yyAction5(strm, yyNO_MATCH)
                  else yyQ15(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"o"
              then yyAction5(strm, yyNO_MATCH)
            else if inp < #"o"
              then if inp = #"n"
