...
fun yyAction0 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; commentLevel := !commentLevel + 1; continue()))
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos "unbalanced comment"; continue()))
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentLevel := !commentLevel - 1; if !commentLevel = 0 then YYBEGIN INITIAL else (); continue()))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction4 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; inString := true; str := ""; strPos := yypos; continue()))
fun yyAction5 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; inString := false; Tokens.STRING(!str, !strPos, yypos)))
fun yyAction6 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN MULTILINE; continue()))
fun yyAction7 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (str := !str ^ translate(yytext, yypos); continue())
      end
...
fun yyQ110 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction13(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\f"
              then yyQ110(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
            else if inp < #"\f"
              then if inp = #"\t"
                  then yyQ110(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction57(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction29(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ60(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ59(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ57(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ62(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  ...
                  then if inp = #"h"
                      then yyQ63(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                      else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp = #"o"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ70(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction24(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction19(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ56(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ56(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ56(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ94(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ56(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ37 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ100(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
...
fun yyQ33 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ103(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
...
fun yyQ104 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ104(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ31 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ18(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
...
fun yyQ106 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction16(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\f"
              then yyQ106(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp < #"\f"
              then if inp = #"\t"
                  then yyQ106(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
       ...
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"A"
              ...
              then if inp = #")"
                  then yyQ25(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp < #")"
                  then if inp = #" "
                      ...
                      then if inp = #"\v"
                          ...
                          then if inp = #"\t"
                              ...
                              else yyQ20(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                        else if inp = #"\f"
                          then yyQ21(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                          else yyQ20(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                    else if inp = #"&"
                      then yyQ23(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                    else if inp < #"&"
                      then if inp = #"\""
                      ...
                      then yyQ20(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                      else yyQ24(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp = #"0"
                  ...
                  then if inp = #"-"
                      ...
                      then if inp = #"+"
                          ...
                          else yyQ28(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                    else if inp = #"."
                      then yyQ30(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                      else yyQ31(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp = #"<"
                  then yyQ35(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp < #"<"
                  then if inp = #":"
                      then yyQ33(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                    else if inp = #";"
                      then yyQ34(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
              ...
              then if inp = #"c"
                  ...
                  then if inp = #"]"
                      ...
                      then if inp = #"["
                          ...
                          then yyQ20(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                          else yyQ38(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                    else if inp = #"a"
              ...
              then if inp = #"p"
                  ...
                  then if inp = #"n"
                      ...
                      then yyQ38(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                      else yyQ49(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp = #"t"
                  then yyQ50(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                  else yyQ38(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp = #"|"
              then yyQ54(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp < #"|"
              then if inp = #"x"
                  then yyQ38(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp < #"x"
                  ...
                  then yyQ53(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                  else yyQ38(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp = #"}"
              then yyQ55(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
              else yyQ20(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
      (* end case *))
